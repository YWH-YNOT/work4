...
const navGroups: NavGroup[] = [
  {
    title: 'AI助学',
    subtitle: '知识库、图谱与问答记录',
    items: [
      { to: '/teacher/resources', icon: 'FolderOpened', label: '课程知识库' },
      { to: '/teacher/knowledge', icon: 'Share', label: '知识图谱' },
      { to: '/teacher/logs', icon: 'ChatDotRound', label: 'AI问答记录' },
    ],
  },
  {
    title: '课堂表现智能分析',
    subtitle: '视频点名与行为分析',
    items: [
      { to: '/teacher/posture', icon: 'View', label: '课堂视频分析' },
      { to: '/teacher/attendance', icon: 'Check', label: '自动点名与考勤' },
    ],
  },
  {
    title: '课程全过程考核与评价',
    subtitle: '任务、测验、成绩与反馈',
    items: [
      { to: '/teacher/dashboard', icon: 'House', label: '教学总览' },
      { to: '/teacher/courses', icon: 'Collection', label: '授课课程' },
      { to: '/teacher/course-progress', icon: 'DataAnalysis', label: '课程学情' },
      { to: '/teacher/grades', icon: 'TrophyBase', label: 'AI学情分析' },
      { to: '/teacher/assignments', icon: 'Document', label: '作业/实验/报告' },
      { to: '/teacher/quiz', icon: 'Memo', label: '课堂测验' },
      { to: '/teacher/gradebook', icon: 'TrophyBase', label: '成绩管理' },
      { to: '/teacher/announcements', icon: 'Bell', label: '课程公告' },
      { to: '/teacher/discussions', icon: 'ChatRound', label: '课程讨论' },
    ],
  },
]
</script>
